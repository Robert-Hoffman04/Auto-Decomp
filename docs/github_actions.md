...
3. Once the build container action completes, visit the package settings. (Screenshots removed in this repository copy.)

4. Under "Manage Actions access", add your project's main repository with the "Read" role:  
    (Screenshot removed in this repository copy.)
